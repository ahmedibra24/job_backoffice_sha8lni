        ...
        <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow">
            <form method="POST" action="{{ route('category.update', $category->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="{{ old('name', $category->name) }}" name="name" id="name" placeholder="Enter category name" class=" {{ $errors->has('name') ? 'border-red-500' : '' }} w-full border border-gray-300 p-2 rounded placeholder-gray-400" >
                    @error('name')
